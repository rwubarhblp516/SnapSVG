 ...
 * @returns {string}
 */
export function trace_image_to_svg(image_bytes, color_count, path_precision, corner_threshold, filter_speckle, color_mode) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.trace_image_to_svg(ptr0, len0, color_count, path_precision, corner_threshold, filter_speckle, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function trace_rgba_to_svg(rgba_data, width, height, color_count, path_precision, corner_threshold, filter_speckle, color_mode) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ptr1 = passStringToWasm0(color_mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.trace_rgba_to_svg(ptr0, len0, width, height, color_count, path_precision, corner_threshold, filter_speckle, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
function __wbg_get_imports(memory) {
    ...
    imports.wbg.memory = memory || new WebAssembly.Memory({initial:22,maximum:32768,shared:true});
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('snapsvg_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
